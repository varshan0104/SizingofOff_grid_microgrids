...
"""----------Cold season; June, July, 61 days (regular school, low visitor activity)-------------"""
...
Fan_SD = SD.Appliance(SD,2,50,2,6*60,0.2,5,wd_we_type = 0)
...
"""_-----Appliances Visitor hut type 1------------"""
#using r_t = 0.2, r_w = 0.35
...
#using r_t = 0.2 and r_w = 0.35
Fan_Office = Office.Appliance(Office,1,50,1,3*60,0.2,5)
...
#using r_t = 0.2 and r_w = 0.35
Fan_LL = LL.Appliance(LL,2,50,1,2*60,0.2,5)
#time window 1: 12:00-15:00
Fan_LL.windows([12*60,15*60],r_w=0.35)
...
"""--------All week--------"""
Fan_SR = SR.Appliance(SR,2,50,1,4*60,0.2,5)
#time window 1: 12:00-18:00
Fan_SR.windows([12*60,18*60],r_w=0.35)
...
#using r_t = 0.2 and r_w = 0.35
Fan_Class_T2 = Class_T2.Appliance(Class_T2,1,50,1,3*60,0.2,5,wd_we_type = 0)
#time window: 12:00-15:00
Fan_Class_T2.windows([12*60,15*60],r_w=0.35)

#Class 6
#using r_t = 0.2 and r_w = 0.35
Fan_Class_6 = Class_6.Appliance(Class_6,1,50,1,3*60,0.2,5,wd_we_type = 0)
#time window: 12:00-15:00
Fan_Class_6.windows([12*60,15*60],r_w=0.35)
...
#using r_t = 0.2 and r_w = 0.35
Fan_CL = CL.Appliance(CL,2,50,1,5*60,0.2,5,wd_we_type = 0)
#time window: 12:00-19:00
Fan_CL.windows([12*60,19*60],r_w=0.35)
...
#using r_t = 0.2 and r_w = 0.35
Fan_Class_T1 = Class_T1.Appliance(Class_T1,2,50,1,4*60,0.2,5,wd_we_type = 0)
#time window: 12:00-17:00
Fan_Class_T1.windows([12*60,17*60],r_w=0.35)
...
Fan_SC = SC.Appliance(SC,6,50,2,6*60,0.2,5,wd_we_type = 0)
#time window: 17:00-07:00
...
Fan_SC_we = SC.Appliance(SC,3,50,3,7*60,0.2,5,wd_we_type = 1)
#time window 1: 12:00-14:00
#time window 2: 19:00-07:00
