...
"""------------Warm season; 1.-23.September, 24 days (regular school, low visitor activity)-------------"""
...
"""-----Appliances Multiple Purpose Bulding----"""
...
"""-----------Appliances RB1 in Directir's housing area----------------"""
...
#using r_t = 0.1 and r_w = 0.35
PC_HA = HA.Appliance(HA,3,60,1,2*60,0.1,5,occasional_use = 0.5)
#time window: 07:00-23:59
