...
#using r_t = 0.2 and r_w = 0.35
Fan_LL = LL.Appliance(LL,2,50,1,5*60,0.2,5,wd_we_type = 0)
...
"""-------Appliances residential building 1, Director's Housing area----------"""
...
"""-------Appliances Residential Building 2, Director's Housing area----------"""
